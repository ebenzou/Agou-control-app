...
/* 11 */
/*!******************************************************************!*\
  !*** G:/MobileAPP/AGOU/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \******************************************************************/
...
/* 12 */
/*!***********************************************!*\
  !*** G:/MobileAPP/AGOU/pages/index/index.vue ***!
  \***********************************************/
/*! no static exports found */
...
/* 13 */
/*!******************************************************************************!*\
  !*** G:/MobileAPP/AGOU/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \******************************************************************************/
...
/* 14 */
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!G:/MobileAPP/AGOU/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 15 */
/*!************************************************************************!*\
  !*** G:/MobileAPP/AGOU/pages/index/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 16 */
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!G:/MobileAPP/AGOU/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  methods: {
    connectWS: function connectWS() {
      ...
      uni.onSocketOpen(function (res) {
        ...
        var hc = setInterval(that.heartCheck, 2000);
      });
      ...
      uni.onSocketMessage(function (res) {
        ...
        var mode = msg.mode;
        var mand = msg.mand;
        var device_num = msg.client_id;
        var items = that.glist.list;
        switch (msg.type) {
          case "init":
          ...
          case "scripts":
            ...
            for (var _i = 0, _lenI = items.length; _i < _lenI; ++_i) {
              if (items[_i].device_num == device_num) {
                // items[i].device_stat = 'offline';
                switch (mand) {
                  case 'enter_homepageliveroom':
                    that.glist.list[_i].doing = msg.text ? msg.text : "进入直播间失败";
                    break;
                  case 'start':
                    that.glist.list[_i].doing = msg.text;
                    break;
                  case 'online':
                    switch (mode) {
                      case 'zb':
                        that.glist.list[_i].doing = "直播模式ing...";
                        break;
                      case 'yh':
                        that.glist.list[_i].doing = "养号模式ing...";
                        break;
                      case 'fd':
                        that.glist.list[_i].doing = "福袋模式ing...";
                        break;
                      default:
                        that.glist.list[_i].doing = msg.text;
                        break;}
          ...
          case "info":
            if (stat == "offline") {
              ...
              var _items = that.glist.list;
              var _device_num = msg.dev_num;
              for (var _i2 = 0, _lenI2 = _items.length; _i2 < _lenI2; ++_i2) {
                if (_items[_i2].device_num == _device_num) {
                  that.glist.list[_i2].device_stat = 'offline';
                  that.setStatByDid(_device_num, wsid, 'offline');
                  break;
                }
              }
            }
            ...
            return;
          case "run_state":
            for (var _i3 = 0, _lenI3 = items.length; _i3 < _lenI3; ++_i3) {
              if (items[_i3].device_num == msg.dev_num) {
                // items[i].device_stat = 'online';
                that.glist.list[_i3].device_stat = 'online';
                that.glist.list[_i3].doing = msg.state;
                that.setStatByDid(msg.dev_num, wsid, 'online');
                // break
              }
            }
    ...
    get_device: function get_device(dev_num, wsid) {var _this2 = this;
      uni.request({
        ...
        success: function success(res) {
          if (res.statusCode !== 200) {
            ...
            if (res.data.msg == "success") {
              _this2.deviceList = _this2.deviceList.concat(res.data.data);
            }
          }
        },
    ...
    setGroup: function setGroup() {var _this3 = this;
      if (this.count == 0) {
        this.hideModal();
        uni.showToast({
          title: '未指定设备',
      ...
      uni.request({
        ...
        complete: function complete() {
          _this3.hideModal('groupDevices');
        } });


    },
    setDeviceNum: function setDeviceNum() {
      console.log('设备号', this.modalDevice);
      console.log('编号', this.d_num);
      var items = this.glist.list;
      var did = this.modalDevice;
      var num = this.d_num;
      for (var i = 0, lenI = items.length; i < lenI; ++i) {
    ...
    showModal: function showModal(e) {
      ...
      var modal_value = e.currentTarget.dataset.value; //单选设备时弹窗传递的值
      var devices = [];
    ...
    clearTxt: function clearTxt(e) {
      e.detail.value = '';
      this.d_num = '';
    },
    selectAll: function selectAll() {
      for (var i = 0; i < this.glist.list.length; i++) {
    ...
    liveCommand: function liveCommand(e, t) {
      var devices = [];
      this.glist.list.forEach(function (e, i) {
        if (e.checked) {
          devices = devices.concat(e);
    ...
    ctlCmd: function ctlCmd(e) {
      var _this = this;
      var cmds = this.cmdList;
      var values = e.currentTarget.dataset.value;
      for (var i = 0, lenI = cmds.length; i < lenI; ++i) {
        if (cmds[i].id == values) {
          if (cmds[i].type == 0) {
            // 如果type是0时,则直接发送命令
    ...
    sendCommand: function sendCommand(ctl, text) {
      var items = this.glist.list;
      if (this.count == 0) {
        this.hideModal();
        uni.showToast({
      ...
      for (var i = 0; i < items.length; i++) {
        if (items[i].checked) {
          var str = '{"type":"control","admin_id":"' + uni.getStorageSync('username') + '","toid":"' + items[i].device_num + '","todo":"' + ctl + '","text":"' + text + '"}';
          console.log(str);
          uni.sendSocketMessage({
            data: str });
    ...
    ChooseGroup: function ChooseGroup(e) {
      console.log(e);
      var items = this.glist.group;
      var values = e.currentTarget.dataset.value;
      for (var i = 0, lenI = items.length; i < lenI; ++i) {
        if (items[i].id == values) {
          console.log(items[i]);
    ...
    selCfg: function selCfg(e) {
      console.log(e);
      var items = this.cfgList;
      var values = e.currentTarget.dataset.value;
      for (var i = 0, lenI = items.length; i < lenI; ++i) {
        if (items[i].id == values) {
          console.log(items[i]);
    ...
    getCmds: function getCmds() {var _this4 = this;
      uni.request({
    ...
    getCfgList: function getCfgList(c) {
      var _this = this;
      uni.request({
    ...
    getData: function getData(uid, gid) {
      var _this = this;
      uni.request({
          ...
          if (res.statusCode !== 200) {
            ...
            if (res.data.code == 200) {
              ...
              res.data.list.forEach(function (e, i) {
                ...
                e.doing = 'N/A';
                // 对所属设备通发消息，检测设备在线状态。
                var str = '{"type":"control","admin_id":"' + username + '","toid":"' + e.device_num + '","todo":"run_state","text":"run_state"}';
                uni.sendSocketMessage({
                  data: str });
    ...
    setStatByDid: function setStatByDid(did, wsid, stat) {
      uni.request({
        url: this.API_URL + 'update/info',
        method: 'POST',
        data: {
    ...
    setStatByWsid: function setStatByWsid(wsid, stat) {
      uni.request({
    ...
    enterLiveroom: function enterLiveroom() {var _this5 = this;
      // console.log(this.douyin_str);
      var url = this.findUrl(this.douyin_str);
      // console.log(url);
      uni.request({
        ...
        success: function success(res) {
          if (res.statusCode !== 200) {
            ...
            console.log(res);
            _this5.sendCommand("enter_homepageliveroom", "snssdk1128://user/detail/" + res.data);
            // uni.showToast({
...
/* 17 */
/*!********************************************************************************!*\
  !*** G:/MobileAPP/AGOU/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 18 */
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!G:/MobileAPP/AGOU/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
